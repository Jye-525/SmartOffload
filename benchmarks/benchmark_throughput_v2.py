...
def get_requests(args, tokenizer):
    ...
    if args.dataset_path is None or args.dataset_name == "random":
        ...
        print(f"Using RandomDataset with the prefix length: {args.prefix_len} ")
...
def validate_args(args):
    ...
    if args.dataset_name == "longbench":
        print(f"args.longbench_subtask = {args.longbench_subtask}")
        if args.longbench_subtask is None:
            raise ValueError(
                "longbench data requires --longbench-subtask to be set. Please use --longbench-subtask to specify the task.") 
