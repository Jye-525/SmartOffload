...
def main(args: argparse.Namespace):
    ...
    if args.dataset is not None:
        ...
        if args.longbench_max_output_len is not None:
            max_input_len = max_input_len - args.longbench_max_output_len
            max_output_len = args.longbench_max_output_len
        else:
            max_input_len = max_input_len - max(get_lb_dataset2maxgenlen().values())
            max_output_len = None
        ...
        cur_model_name = model_id.split("/")[-1]
        max_input_len = get_max_model_input_length(cur_model_name)
        if args.longbench_v2_max_output_len is not None:
            max_input_len = max_input_len - args.longbench_v2_max_output_len
            max_output_len = args.longbench_v2_max_output_len
        else:
            max_output_len = 128
